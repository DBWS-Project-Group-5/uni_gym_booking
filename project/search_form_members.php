  ...
  <body>
    ...
    <div class="container">
        <div class="row mt-4 justify-content-center">
          <p>Members search form</p>
        </div>
        <div class="row fullheight mt-1 justify-content-center">
            
            <form method="post" action="search_result_members.php">
                <div class="form-group">
                    <label for="searchFormEmail">Email</label>
                    <input type="text" class="form-control" name="mail" id="searchFormEmailInput" placeholder="abo@jub.de">
                  </div>
                <div class="form-group">
