  ...
  <body>
    ...
    <div class="container">
        <div class="row mt-4 justify-content-center">
          <p>Event search form</p>
        </div>
        <div class="row fullheight mt-1 justify-content-center">
            
            <form method="post" action="search_result_event.php">
                <div class="form-group">
                    <label for="searchFormName">Name</label>
                    <input type="text" class="form-control" name="event_name" id="searchFormNameInput" placeholder="Swimming competition!">
                  </div>
                <div class="form-group">
