...
<html>
  <head>
    <title>Imprint | Bookr</title>
    <link href="assets/imprint.css" rel="stylesheet">
    ...
    <body>
        ...
        <div class="container">
            <div class="row align-items-center fullheight">
              ...
              <div class="col">
                <p class="disc">Website Designer & Creater
                  <p class="bdy">Nodirbek Ibragimov
                    <div class="blundrln">n.ibragimov@jacobs-university.de</div>
                  </p>

                  <p class="bdy">Aoge Bo
                    <div class="blundrln">abo@jaocbs-university.de</div>
                  </p>

                  <p class="bdy">Shubhushan Kattel
                    <div class="blundrln">s.kattel@jacobs-university.de</div>
                  </p>
                </p>
              </div>
            </div>
