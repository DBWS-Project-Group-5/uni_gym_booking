  ...
  <head>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row fullheight align-items-center" style="background-color:lightgrey;">
                <div class="col-sm-3"></div>
                <div class="col-sm-3">
                    <h1>Oops! *o*</h1>
                    <p>Error occurred in the process</p>
                </div>
                <div class="col-sm-6">
                    <img src="assets/dead_com.gif" class="rounded" alt="dead com" width="304" height="236">
                </div>
            </div>
        </div>
